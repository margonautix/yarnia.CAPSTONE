...
// Fetch bookmarked stories for a specific author
export async function fetchBookmarkedStories(authorId) {
  try {
    const response = await fetch(`${API_URL}/users/${authorId}/bookmarks`);
    if (!response.ok) {
...
// Remove a bookmark for a specific story
